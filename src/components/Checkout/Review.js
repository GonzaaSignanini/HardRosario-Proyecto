...
import { createOrder, getUserId } from "../../Services/firebase";
...
const Review = ({ user, setUser, setSteps, setResult }) => {
  ...
  /*--------------Payments Mock-------------*/
  const payments = [
    { name: "Tarjeta", detail: "Mastercard" },
    { name: "Número", detail: "xxxx-xxxx-xxxx-7030" },
    { name: "Vencimiento", detail: "08/2025" },
  ];
